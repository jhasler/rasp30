function [x,y,typ]=macrocab_fgota1(job,arg1,arg2)
    x=[];y=[];typ=[];
    select job
    ...
    case 'define' then
        sel_or_unsel="-";
        ibias_name="fgota1_ibias";
        ibias_default="2e-6";
        pbias_name="fgota1_pbias";
        pbias_default="2e-6";
        nbias_name="fgota1_nbias";
        nbias_default="2e-6";
        smallcap_bigcap="0";
        fg_address=[32;60;33;61;33;60;31;61;31;60];
