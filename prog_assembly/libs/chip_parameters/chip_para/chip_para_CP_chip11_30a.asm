...
.set CPL_GATE_S_OTA, 0x4b30 /* Gate(OTA) = 2.1V */
...
.set CPL_GATE_S_MITE, 0x4b30 /* Gate(MITE) = 2.1V */
.set CPL_INJ_T_MITE, 1 /* Injection time (*10us) */
.set CPL_NUM_MITE, 20 /* # of Measured Coarse Progrm */
.set CPL_GATE_S_DIRSWC, 0x1f30 /* Gate(DIRSWC) = 1.7V */
