...
.set RI_GATE_S_OTA, 0x4f30 /* Gate(OTA) = 2.1V */
...
.set RI_GATE_S_MITE, 0x4f30 /* Gate(MITE) = 2.1V */
...
.set RI_GATE_S_DIRSWC, 0x2530 /* Gate(DIRSWC) = 1.7V */
...
.set RIL_GATE_S_OTA, 0x4f30 /* Gate(OTA) = 2.1V */
...
.set RIL_GATE_S_MITE, 0x4f30 /* Gate(MITE) = 2.1V */
...
.set RIL_GATE_S_DIRSWC, 0x2530 /* Gate(DIRSWC) = 1.7V */
