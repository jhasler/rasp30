...
/**********************************/
.set ADC_1nA, 3910 /* 1nA ADC value */

/* sub threshold */
.set FPS_GATE_S_SWC, 0x8030 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x8030 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x8030 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x8030 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x8030 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x8030 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x8030 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x8030 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x8030 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x8030 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
.set FPL_GATE_S_OTA, 0x4f30 /* Gate(OTA) = 2.1V */
...
.set FPL_GATE_S_MITE, 0x4f30 /* Gate(MITE) = 2.1V */
...
.set FPL_GATE_S_DIRSWC, 0x2530 /* Gate(DIRSWC) = 1.7V */
