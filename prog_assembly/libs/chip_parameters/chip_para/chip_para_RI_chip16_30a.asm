...
.set RI_VC1_SWC, 7170 /* Ivfg @Vgm=0V -> 1nA@Vgm=0.6V */
.set RI_VC2_SWC, 6955 /* Ivfg*2/5 @Vgm=0V */
.set RI_VC3_SWC, 6311 /* Ivfg*1/10 @Vgm=0V */
.set RI_VC4_SWC, 5022 /* Ivfg=1nA @Vgm=0V */
...
.set RI_VC1_OTA, 8350 /* Ivfg @Vgm=0V -> 1nA@Vgm=0.6V */
.set RI_VC2_OTA, 8018 /* Ivfg*2/5 @Vgm=0V */
.set RI_VC3_OTA, 7019 /* Ivfg*1/10 @Vgm=0V */
.set RI_VC4_OTA, 5022 /* Ivfg=1nA @Vgm=0V */
...
.set RI_VC1_OTAREF, 7240 /* Ivfg @Vgm=0V -> 1nA@Vgm=0.6V */
.set RI_VC2_OTAREF, 7018 /* Ivfg*2/5 @Vgm=0V */
.set RI_VC3_OTAREF, 6353 /* Ivfg*1/10 @Vgm=0V */
.set RI_VC4_OTAREF, 5022 /* Ivfg=1nA @Vgm=0V */
...
.set RI_VC1_MITE, 8728 /* Ivfg @Vgm=0V -> 1nA@Vgm=0.6V */
.set RI_VC2_MITE, 8357 /* Ivfg*2/5 @Vgm=0V */
.set RI_VC3_MITE, 7246 /* Ivfg*1/10 @Vgm=0V */
.set RI_VC4_MITE, 5022 /* Ivfg=1nA @Vgm=0V */
...
.set RI_VC1_DIRSWC, 7237 /* Ivfg @Vgm=0V -> 1nA@Vgm=0.6V */
.set RI_VC2_DIRSWC, 7015 /* Ivfg*2/5 @Vgm=0V */
.set RI_VC3_DIRSWC, 6351 /* Ivfg*1/10 @Vgm=0V */
.set RI_VC4_DIRSWC, 5022 /* Ivfg=1nA @Vgm=0V */
...
.set RIL_VC1_SWC, 5022 /* Ivfg=1n A@Vgm=0V */
.set RIL_VC2_SWC, 4425 /* Ivfg=lowest current @Vgm=0V */
...
.set RIL_VC1_OTA, 5022 /* Ivfg=1n A@Vgm=0V */
.set RIL_VC2_OTA, 4416 /* Ivfg=lowest current @Vgm=0V */
...
.set RIL_VC1_OTAREF, 5022 /* Ivfg=1n A@Vgm=0V */
.set RIL_VC2_OTAREF, 4415 /* Ivfg=lowest current @Vgm=0V */
...
.set RIL_VC1_MITE, 5022 /* Ivfg=1n A@Vgm=0V */
.set RIL_VC2_MITE, 4420 /* Ivfg=lowest current @Vgm=0V */
...
.set RIL_VC1_DIRSWC, 5022 /* Ivfg=1n A@Vgm=0V */
.set RIL_VC2_DIRSWC, 4417 /* Ivfg=lowest current @Vgm=0V */
