...
/**********************************/
.set ADC_1nA, 5022 /* 1nA ADC value */

/* sub threshold */
.set FPS_GATE_S_SWC, 0x6a30 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTA, 0x6a30 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_OTAREF, 0x6a30 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_MITE, 0x6a30 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPS_GATE_S_DIRSWC, 0x6a30 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
...
/* above threshold */
.set FPA_GATE_S_SWC, 0x6a30 /* Gate(SWC) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTA, 0x6a30 /* Gate(OTA) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_OTAREF, 0x6a30 /* Gate(OTAREF) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_MITE, 0x6a30 /* Gate(MITE) = 2.9V @ IVDD 6.0V */
...
.set FPA_GATE_S_DIRSWC, 0x6a30 /* Gate(DIRSWC) = 2.9V @ IVDD 6.0V */
