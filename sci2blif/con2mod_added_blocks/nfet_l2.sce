if temp_str(9) == """nfet""" then
    flag_1=1;
    bl_id_table(bl_id_line)=temp_str(5); bl_id_line=bl_id_line+1;
    
    // BasicBlock
    xcos_mod(line_mod)=temp_str(1)+" "+temp_str(4)+"="+temp_str(5)+" "+temp_str(6)+"="+temp_str(7)+" "+temp_str(8)+"=""NMOS_mod"" "+temp_str(10)+"="+temp_str(11)+" "++temp_str(12)+"=""NMOS_ekv"" "+temp_str(14)+"=""DEFAULT"" "++temp_str(16)+"=""NMOS_mod;flip=false;mirror=false"""; line_mod=line_mod+1;
    ...
    xcos_mod(line_mod)="data column=""0"" line=""0"" value=""NMOS_mod""/"; line_mod=line_mod+1;
    xcos_mod(line_mod)="/ScilabString"; line_mod=line_mod+1;
    xcos_mod(line_mod)="ScilabString height=""1"" width=""1"""; line_mod=line_mod+1;
